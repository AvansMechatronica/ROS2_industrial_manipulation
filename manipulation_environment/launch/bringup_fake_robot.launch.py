...
def launch_setup(context, *args, **kwargs):
    ...
    ros_namespace = LaunchConfiguration('ros_namespace', default='xarm6').perform(context)
...
#            'geometry_mesh_tcp_rpy': geometry_mesh_tcp_rpy,
    ...
    move_group_path = os.path.join(
        get_package_share_directory('manipulation_moveit_config'),
        'launch',
    ...
    # RViz
    rviz_config_file = (
        get_package_share_directory("manipulation_environment") + "/config/fake_robot.rviz"
    )
